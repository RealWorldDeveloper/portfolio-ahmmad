...
function loadSkills1() {
  ...
  function progressSim() {
    ...
    ctx.beginPath();
    ctx.arc(60, 60, 30, start, diff / 10 + start, false); //.arc(x, y , radius, startAngle, endAngle, anticlockwise)
    ctx.stroke();
...
function loadSkills2() {
  ...
  function progressSim() {
    ...
    ctx.clearRect(0, 0, cw, ch);
    ctx.lineWidth = 3; //thickness of the line
    ctx.fillStyle = '#266887';
    ctx.strokeStyle = "#266887";
    ctx.textAlign = 'center';
    ctx.font = "18px Roboto";
    ctx.fillText(al + '%', cw * .5 + 2, ch * .5 + 8, cw);
    ctx.beginPath();
    ctx.arc(60, 60, 33, start, diff / 10 + start, false); //.arc(x, y , radius, startAngle, endAngle, anticlockwise)
    ctx.stroke();
...
function loadSkills3() {
  ...
  function progressSim() {
    ...
    ctx.clearRect(0, 0, cw, ch);
    ctx.lineWidth = 3; //thickness of the line
    ctx.fillStyle = '#c93b66';
    ctx.strokeStyle = "#c93b66";
    ctx.textAlign = 'center';
    ctx.font = "18px Roboto";
    ctx.fillText(al + '%', cw * .5 + 2, ch * .5 + 8, cw);
    ctx.beginPath();
...
function loadSkills4() {
  ...
  function progressSim() {
    ...
    ctx.clearRect(0, 0, cw, ch);
    ctx.lineWidth = 3; //thickness of the line
    ctx.fillStyle = '#330b68';
    ctx.strokeStyle = "#330b68";
    ctx.textAlign = 'center';
    ctx.font = "18px Roboto";
    ctx.fillText(al + '%', cw * .5 + 2, ch * .5 + 8, cw);
    ctx.beginPath();
